	...
	public class DisplayObjectLoader extends LoaderItem {
		...
		protected function _closeFallbackAudit():void {
			if (_fallbackAudit != null) {
				...
				_fallbackAudit.contentLoaderInfo.addEventListener(IOErrorEvent.IO_ERROR, _auditStreamHandler, false, 0, true);
				_fallbackAudit.contentLoaderInfo.addEventListener(SecurityErrorEvent.SECURITY_ERROR, _auditStreamHandler, false, 0, true);
				try {
		...
		protected function _refreshLoader(unloadContent:Boolean=true):void {
			if (_loader != null) {
				...
				_loader.contentLoaderInfo.removeEventListener(IOErrorEvent.IO_ERROR, _failHandler);
				_loader.contentLoaderInfo.removeEventListener(SecurityErrorEvent.SECURITY_ERROR, _securityErrorHandler);
			...
			_loader.contentLoaderInfo.addEventListener(IOErrorEvent.IO_ERROR, _failHandler, false, 0, true);
			_loader.contentLoaderInfo.addEventListener(SecurityErrorEvent.SECURITY_ERROR, _securityErrorHandler, false, 0, true);
